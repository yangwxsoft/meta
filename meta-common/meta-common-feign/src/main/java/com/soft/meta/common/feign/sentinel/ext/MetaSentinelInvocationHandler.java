 ...
 */
@Slf4j
public class MetaSentinelInvocationHandler implements InvocationHandler {
	...
	MetaSentinelInvocationHandler(Target<?> target, Map<Method, InvocationHandlerFactory.MethodHandler> dispatch,
	...
	public boolean equals(Object obj) {
		if (obj instanceof SentinelInvocationHandler) {
			MetaSentinelInvocationHandler other = (MetaSentinelInvocationHandler) obj;
