 ...
 */
@Slf4j
public class MetaSecurityBeanDefinitionRegistrar implements ImportBeanDefinitionRegistrar {
	...
	public void registerBeanDefinitions(AnnotationMetadata metadata, BeanDefinitionRegistry registry) {
		...
		beanDefinition.setBeanClass(MetaResourceServerConfigurerAdapter.class);
