...
package com.soft.meta.common.security.feign;
 ...
 */
@Slf4j
public class MetaFeignClientInterceptor extends OAuth2FeignRequestInterceptor {
	 ...
	 */
	public MetaFeignClientInterceptor(OAuth2ClientContext oAuth2ClientContext, OAuth2ProtectedResourceDetails resource,
