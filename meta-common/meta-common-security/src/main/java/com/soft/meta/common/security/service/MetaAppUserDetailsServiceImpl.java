...
import com.soft.meta.admin.api.feign.RemoteUserService;
...
public class MetaAppUserDetailsServiceImpl implements MetaUserDetailsService {
	...
	public UserDetails loadUserByUsername(String phone) {
		...
		if (cache != null && cache.get(phone) != null) {
			return (MetaUser) cache.get(phone).get();
		}
	 ...
	 */
	@Override
	public UserDetails loadUserByUser(MetaUser metaUser) {
		return this.loadUserByUsername(metaUser.getPhone());
	}
